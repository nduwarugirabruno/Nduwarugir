...
<body style="margin: 0; padding: 0; font-family: sans-serif; width: 100%"> 
    <header style="display: flex; justify-content: space-between; align-content: center; align-items: center; background: black; padding: 1rem; width: 100%">
    ...
    <section class="main-content column" style="width: 100%">
            ...
            <table style="border-collapse: collapse; width: auto; margin: 1rem 0;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 0.5rem; text-align: center;">x</td>
                        <td style="padding: 0.5rem; text-align: center;">x</td>
                        <td style="padding: 0.5rem; text-align: center;">x</td>
